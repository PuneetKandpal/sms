...
export default function ContentArchitectureShimmer() {
  return (
      ...
      >
        <div className="flex justify-between items-center">
          <div className="flex-1">
            <div className="h-9 w-72 bg-gray-200 rounded-lg mb-2"></div>
            <div className="h-4 w-48 bg-gray-200 rounded"></div>
          </div>

          {/* Metrics */}
          <div className="flex gap-4 flex-1 justify-center">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg px-4 py-3 min-w-[140px]">
              ...
              <div className="h-8 w-12 bg-blue-200 rounded"></div>
            </div>

            <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg px-4 py-3 min-w-[140px]">
              <div className="flex items-center gap-2 mb-1">
